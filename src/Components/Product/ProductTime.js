                          ...
                          <div className="table-container">
                            <table className="min-w-full divide-y divide-neutral-950 sticky-header border border-slate-500">
                              <thead className="bg-slate-300 " >
                                ...
                                {apiResponse[0] && apiResponse[0].length > 0 && apiResponse[0][1].FACTORY =='TOTAL' && (apiResponse[0][1].DAY !== 'TODAY' || apiResponse[0][1].DAY !== 'YESTERDAY') && (
                                <tr>
                                  <th scope="col" className="py-3.5 pl-4 pr-3 text-center text-sm font-semibold text-gray-900 sm:pl-6">
                              ...
                              {apiResponse && apiResponse.length > 0 ? (
                                <tbody className="divide-y divide-neutral-950 bg-white">
                                  {apiResponse[0].map((item, index) => item.FACTORY !== 'TOTAL' && (
                                    ...
                                    key={index}
                                    className={`${
                                      item.FACTORY === 'TOTAL' ? 'bg-yellow-500 text-center' : ''
                                    } ${index > 0 ? 'sticky-row' : ''}`}
                                  >

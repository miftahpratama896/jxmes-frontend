  ...
  const fetchData = async () => {
    try {
      ...
      const response = await axios.get(
        "http://172.16.200.28:3000/product-pcard",
        {
          params: {
                              ...
                              <tr key={rowIndex}>
                                ...
                                <td className="whitespace-nowrap py-4 pl-4 pr-3 text-center text-sm font-medium text-gray-900 sm:pl-6">
                                  {new Date(item.INPUT_DATE)
                                    ...
                                    .replace(/\//g, "-")}{" "}
                                  {new Date(item.INPUT_DATE).toLocaleTimeString(
                                    "en-US",
                                    {
                                      hour12: true,
                                      hour: "2-digit",
                            ...
                            <tr>
                              ...
                              {columns.map((columnName, index) => (
                                <th
                                  ...
                                  className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium"
                                >
                                  {calculateColumnTotal(columnName) !== null &&
                                  calculateColumnTotal(columnName) !== undefined
                                ...
                                <tr key={rowIndex}>
                                  ...
                                  {columns.map((columnName, columnIndex) => (
                                    <td
                                      key={columnIndex}
                                      className={`whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium ${
                                        (item[columnName] / item.TARG_HOUR) *
                                          100 ===
                                          0 ||
                                        isNaN(
                                          (item[columnName] / item.TARG_HOUR) *

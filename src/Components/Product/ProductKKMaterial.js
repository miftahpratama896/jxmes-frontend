                      ...
                      <table className="min-w-full divide-y divide-neutral-950 border border-slate-500 ">
                        <thead className="bg-slate-300 ">
                          <tr className="sticky top-0 text-white z-10 bg-gray-900 whitespace-nowrap">
                            ...
                            <th
                              scope="col"
                              className="sticky left-[97px] bg-gray-900 px-3 py-3.5 text-center text-sm font-semibold"
                            >
                              PLANT
                            </th>
                            <th
                              scope="col"
                              className="sticky left-[154px] bg-gray-900 px-3 py-3.5 text-center text-sm font-semibold"
                            >
                              LINE
                            </th>
                            <th
                              scope="col"
                              className="sticky left-[195px] bg-gray-900 px-3 py-3.5 text-center text-sm font-semibold"
                            >
                              DEPT
                            </th>
                            <th
                              scope="col"
                              className="sticky left-[320px] bg-gray-900 px-3 py-3.5 text-center text-sm font-semibold"
                            >
                              MR NO
                            </th>
                            <th
                              scope="col"
                              className="sticky left-[423px] bg-gray-900 px-3 py-3.5 text-center text-sm font-semibold"
                            >
                              RELEASE
                            </th>
                            <th
                              scope="col"
                              className="sticky left-[493px] bg-gray-900  px-3 py-3.5 text-center text-sm font-semibold"
                            >
                              MODEL
                            </th>
                            <th
                        ...
                        <tbody className="divide-y divide-neutral-950 bg-white">
                          {data.map((item) => (
                            <tr key={item.index}>
                              <td className="sticky left-0 bg-gray-50 whitespace-nowrap text-center py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6 ">
                                {item.REQ_DATE
                              ...
                              <td className="sticky left-[97px] bg-gray-50 whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">
                                {item.FACTORY}
                              </td>
                              <td className="sticky left-[154px] bg-gray-50 whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">
                                {item.LINE}
                              </td>
                              <td className="sticky left-[195px] bg-gray-50 whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">
                                {item.DEPT}
                              </td>
                              <td className="sticky left-[320px] bg-gray-50 whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">
                                {item.MR_NO}
                              </td>
                              <td className="sticky left-[423px] bg-gray-50 whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">
                                {item.RLS}
                              </td>
                              <td className="sticky left-[493px] bg-gray-50 whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">
                                {item.MODEL}
                              </td>

...
const ProductMaterialBalance = () => {
  ...
  const handleModelChange = (selectedValue) => {
    ...
    const fetchData = async () => {
      setUpdating(true);
      try {
        const response = await axios.post('http://172.16.200.28:3000/product-material-balance', {
                      ...
                      <tbody className="divide-y divide-neutral-950 bg-white">
                        ...
                        {data.map(item => (
                          <tr key={item.index}>
                            ...
                            <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">{item.ORDER_QTY?.toLocaleString()}</td>
                            <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">{item.MAT_CODE}</td>
                            <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">{item.GROUP_CODE}</td>
                            ...
                            <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">{item.PO_QTY}</td>
                            <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">{item.INPUT_QTY}</td>
                            <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">{item.BALANCE}</td>

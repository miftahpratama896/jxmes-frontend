...
const ProductPersonel = () => {
  ...
  }, [autoUpdate, date, selectedFilter,selectedMainDept1, selectedMainDept,selectedSubDept]);
  ...
  useEffect(() => {
    ...
    if (data) {
      ...
      const uniqueMainDept1Options = [...new Set(data && data.map(item => item.HDPT_NAME))];
      setFilteredMainDept1Options(uniqueMainDept1Options);

      const uniqueMainDeptOptions = [...new Set(filteredData.map(item => item.DEPT))];
      setFilteredMainDeptOptions(uniqueMainDeptOptions);
  
      const uniqueSubDeptOptions = [...new Set(filteredData.map(item => item['SUB DEPT']))];
      ...
      <div className="mx-auto max-w-full px-6 lg:px-1">
        <div className="px-4 sm:px-6 lg:px-8">
          ...
          <div className="sm:flex sm:items-center py-3">
            ...
            <div className="mt-4 sm:mt-0 sm:ml-4">
                          <Combobox as="div" onChange={handleMainDeptChange} value={selectedMainDept} >
                            <Combobox.Label className="block text-sm font-medium leading-6 text-gray-900">MAIN DEPARTMENT</Combobox.Label>
                              ...
                              <Combobox.Options className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                                ...
                                {filteredMainDeptOptions.map((MainDept) => (
                                  ...
                                  >
                                    {({ active, selected }) => (
                                      <>
                                        <span className={classNames('block truncate', selected && 'font-semibold')}>{MainDept}</span>
                                        {selected && (
                                          <span
                                            className={classNames(
                                              'absolute inset-y-0 right-0 flex items-center pr-4',
             ...
             {selectedFilter === '3' && (
                        <div className="mt-4 sm:mt-0 sm:ml-4">
                          <Combobox as="div" onChange={handleSubDeptChange} value={selectedSubDept} >
                            <Combobox.Label className="block text-sm font-medium leading-6 text-gray-900">SUB DEPARTMENT</Combobox.Label>
                            <div className="relative mt-2">
                              <Combobox.Input
                                className="w-full rounded-md border-0 bg-white py-1.5 pl-3 pr-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                              ...
                              <Combobox.Options className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                                ...
                                {filteredSubDeptOptions.map((SubDept) => (
                                  ...
                                  >
                                    {({ active, selected }) => (
                                      <>
                                        <span className={classNames('block truncate', selected && 'font-semibold')}>{SubDept}</span>
                                        {selected && (
                                          <span
                                            className={classNames(
                                              'absolute inset-y-0 right-0 flex items-center pr-4',
            ...
            <div className="mt-4 sm:mt-0 sm:ml-4">
                          <Combobox as="div" onChange={handleMainDept1Change} value={selectedMainDept1} >
                            <Combobox.Label className="block text-sm font-medium leading-6 text-gray-900">MAIN DEPARTMENT</Combobox.Label>
                            <div className="relative mt-2">
                              <Combobox.Input
                                className="w-full rounded-md border-0 bg-white py-1.5 pl-3 pr-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                              ...
                              <Combobox.Options className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                                ...
                                {filteredMainDept1Options.map((MainDept1) => (
                                  ...
                                  >
                                    {({ active, selected }) => (
                                      <>
                                        <span className={classNames('block truncate', selected && 'font-semibold')}>{MainDept1}</span>
                                        {selected && (
                                          <span
                                            className={classNames(
                                              'absolute inset-y-0 right-0 flex items-center pr-4',
                  ...
                  <div className="table-container">
                    ...
                    {selectedFilter !== '3' && (
                      ...
                      <thead className="bg-slate-300">
                        ...
                        {data && data.length > 0 && data[0].ID === 'TOTAL' && (
                          <tr>
                            <th scope="col" colSpan={6} className="px-3 py-3.5 text-center text-sm font-semibold text-gray-900">
                                    {data[0].ID}
                            </th>
                            <th scope="col" className="px-3 py-3.5 text-center text-sm font-semibold text-gray-900">
                                    {data[0]['SUB DEPT']}
                    ...
                    {selectedFilter === '3' && (
                    <tbody className="divide-y divide-neutral-950 bg-white">
                         {data && data.slice(0, 500).map(item => (
                            // Menambahkan kondisi untuk memfilter item dengan HDPT_NAME tidak sama dengan 'TOTAL'
                            item.ID !== 'TOTAL' && (
                                <tr key={item.ID}>
                                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">
                                    ...
                                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">{item.NAME}</td>
                                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">{item.SEXX}</td>
                                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">{item.ENDT}</td>
                                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">{item.DEPT}</td>
                                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">{item['MID DEPT']}</td>
                                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">{item['SUB DEPT']}</td>
                                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">{item.HAML}</td>
                                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">{item.ABSEN}</td>
                                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">{item.SAKIT}</td>
                                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">{item.IJIN}</td>
                                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900 sm:pl-6">{item.CUTI}</td>
                                </tr>
                            )
                        ))}
                    </tbody>

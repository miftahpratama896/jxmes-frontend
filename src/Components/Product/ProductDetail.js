...
const ProductDetail = () => {
  ...
  const convertedRelease = convertToCustomFormat(release);
    ...
    }, [autoUpdate, dateFrom, dateTo, selectedWC, selectedFactory, selectedJXLine, selectedStyle, selectedModel, selectedGender,selectedFilter,release]);
  ...
  const calculateColumnTotal = (columnName) => {
    ...
    useEffect(() => {
      if (data.length > 0) {
        const uniqueJXLineOptions = [...new Set(data[0].map(item => item.SCAN_CELL))];
        setFilteredJXLineOptions(uniqueJXLineOptions);
        
        const uniqueModelOptions = [...new Set(data[0].map(item => item.STYLE_NAME))];
    ...
    <style>
      {`
        ...
        .sticky-header thead tr:nth-child(7) th {
         position: sticky;
         top: 241px; /* Jarak antara subheader dan header pertama, sesuaikan sesuai kebutuhan */
                  ...
                  <div className="table-container">
                    <table className="min-w-full divide-y divide-neutral-950 sticky-header border border-slate-500 ">
                      <thead className="bg-slate-300">
                        <tr>
                          <th scope="col" rowSpan={6} className="py-3.5 pl-4 pr-3 text-center text-sm font-semibold text-gray-900 sm:pl-6">
                            SCAN DATE 
                          </th>
                          <th scope="col" rowSpan={6} className="px-3 py-3.5 text-center text-sm font-semibold text-gray-900">
                            PLANT 
                          </th>
                          {selectedWC !== 'Cutting' && (
                          <th scope="col" rowSpan={6} className="px-3 py-3.5 text-center text-sm font-semibold text-gray-900">
                        ...
                        <th scope="col" className="py-3.5 pl-4 pr-3 text-center text-sm font-semibold text-gray-900 sm:pl-6">
                          ...
                          <th scope="col" colSpan={14} className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">
                            10
                          </th>
                        </tr>
                        <tr>
                        <th scope="col" className="py-3.5 pl-4 pr-3 text-center text-sm font-semibold text-gray-900 sm:pl-6">
                          ...
                          <th scope="col" colSpan={10} className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">
                            7 
                          </th>
                        </tr>
                        <tr>
                        <th scope="col" className="py-3.5 pl-4 pr-3 text-center text-sm font-semibold text-gray-900 sm:pl-6">
                          ...
                          <th scope="col" colSpan={6} className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">
                            13T 
                          </th>
                        </tr>
                        <tr>
                        <th scope="col" className="py-3.5 pl-4 pr-3 text-center text-sm font-semibold text-gray-900 sm:pl-6">
                          ...
                          <th scope="col" colSpan={4} className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">
                            14 
                          </th>
                        ...
                        <tr>
                        <th scope="col" colSpan={selectedWC !== 'Cutting' ? 10 : 9} className="px-3 py-3.5 text-center text-sm font-semibold text-gray-900">
                          TOTAL
                        </th>

                          <th scope="col" className={`px-3 py-3.5 text-center text-sm font-semibold text-gray-900  sm:pl-6`}>
                        ...
                        {data[0]?.map((item, index) => {
                          ...
                          return (
                            <tr key={index}>
                              ...
                              <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900">{item.PLANT}</td>
                              {selectedWC !== 'Cutting' && (
                                 <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900">{item.SCAN_CELL}</td>
                              )}
                              <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900">{item.JX_CELL}</td>
                              <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900">{item.POPD_OPCD}</td>
                              <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900">{item.TYPE}</td>
                              <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900">{item.RELEASE}</td>
                              <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900">{item.STYLE}</td>
                              <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900">{item.STYLE_NAME}</td>
                              <td className="whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium text-gray-900">{item.GENDER}</td>
                              ...
                              {columns.map((columnName, columnIndex) => (
                                  <td 
                                      ...
                                      className={`whitespace-nowrap py-4 pl-4 pr-3 text-xs text-center font-medium ${
                                          item.GENDER === 'WO' ? 'bg-green-300' :
                                          item.GENDER === 'TD' ? 'bg-yellow-300' :
                                          item.GENDER === 'GS' ? 'bg-red-300' :
                                          item.GENDER === 'PS' ? 'bg-blue-300' :
                                          item.GENDER === 'ME' ? 'bg-purple-300' :
                                          ''}`}
                                  >
                                      {item[columnName]}
                                  </td>

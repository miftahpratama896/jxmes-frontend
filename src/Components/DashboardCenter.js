...
const features = [
  {
    ...
    description:
      "Presenting daily Monitoring Plan - Production - Differential with accurate data.",
    icon: CloudArrowUpIcon,
  },
  {
    name: "Calculation of all Monitoring.",
    description:
      "Providing the cumulative calculation of all Monitoring Plan - Production - Differential on a daily basis.",
    icon: LockClosedIcon,
  },
  {
    name: "Advanced Rate Plan - Prod.",
    description:
      "Calculating the Rate of Plan against Production to achieve optimal results.",

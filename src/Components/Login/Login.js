            ...
            <div className="flex relative items-center h-full z-30 px-20 bg-gray-900 bg-opacity-40">
              <div>
                ...
                <p className="max-w-xl mt-3 text-gray-50">
                  Our dedicated team of employees has consistently demonstrated
                  exemplary performance in driving our company towards the
                  realization of becoming a global leader in the footwear
                  industry.
                </p>
              </div>
            </div>
